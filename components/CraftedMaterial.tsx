...
const CraftedMaterial = () => {
  return (
    <section className="my-16 max-w-7xl mx-auto px-6 max-sm:px-2 flex py-16 max-md:flex-col gap-8">
      <div className="flex-[1] flex flex-col  justify-around max-md:items-center gap-4">
        ...
        <button className="bg-[#000] text-standard flex items-start w-[fit-content]  px-8 py-4 rounded-full max-md:px-4 max-md:py-2">Explore</button>
      </div>
