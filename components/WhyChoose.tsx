...
const WhyChoose = () => {
  return (
    <section className="flex max-w-7xl mx-auto px-6 relative py-24 gap-4 max-md:flex-col-reverse justify-between max-md:gap-16">
        ...
        <div className="w-full  grid grid-cols-2 gap-4 ">
          <div className="w-full  flex flex-col  gap-4">
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="md:text-sm text-xs text-[#888] leading-6">
                Donec vitae odio quis nisl dapibus malesuada. Nullam ac aliquet
